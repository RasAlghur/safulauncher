...
export const getPureMetrics = async (chainId: number) => {
  ...
  const [v1Metrics, v2Metrics, v3Metrics] = await Promise.all([
  ...
  return [
    v1Metrics[0] + v2Metrics[0] + v3Metrics[0], // _volumeETH
    v1Metrics[1] + v2Metrics[1] + v3Metrics[1], // _feesETH
    v1Metrics[2] + v2Metrics[2] + v3Metrics[2], // _tokensLaunched
    v1Metrics[3] + v2Metrics[3] + v3Metrics[3], // _tokensListed
    v1Metrics[4] + v2Metrics[4] + v3Metrics[4], // _taxedTokens
    v1Metrics[5] + v2Metrics[5] + v3Metrics[5], // _zeroTaxTokens
    v1Metrics[6] + v2Metrics[6] + v3Metrics[6], // _devRewardsEth
    v3Metrics[7],
    v3Metrics[8],
    v3Metrics[9],
    v3Metrics[10],
