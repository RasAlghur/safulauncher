...
const AdminContractConfigV3 = () => {
    ...
    const [creationHolderThresholdBps, setCreationHolderThresholdBps] = useState<string>("");
        ...
        <div className="p-4 max-w-6xl mx-auto mt-8 space-y-6">
            <div className="text-center mb-8">
                <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-2">
                    SafuLauncher Admin Panel for Address: {SAFU_LAUNCHER_ADDRESSES_V3[networkInfo.chainId]}
                </h1>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                    ...
                    <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                        <div className="text-2xl font-bold text-orange-600 dark:text-orange-400">
                            {(Number(combinedMetrics?.[10]) / Number(combinedMetrics?.[11])) * 100}%
                        </div>
                        <div className="text-sm text-gray-600 dark:text-gray-400">
                            Listing Fee
                        </div>
                    ...
                    <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                        <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">
                            {combinedMetrics?.[14] ? secondsToDays(Number(combinedMetrics[14])) : "0"}
                        </div>
                        <div className="text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                        <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">
                            {combinedMetrics?.[15] ? secondsToDays(Number(combinedMetrics[15])) : "0"}
                        </div>
                        <div className="text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <div className="space-y-4">
                        <div className="grid grid-cols-3 gap-3">
                            <InputField
                                ...
                                placeholder="30"
                                type="number"
                                currentValue={combinedMetrics?.[14] ? secondsToDays(Number(combinedMetrics[14])) : 0}
                            ...
                            <InputField
                                ...
                                placeholder="30"
                                type="number"
                                currentValue={combinedMetrics?.[15] ? secondsToDays(Number(combinedMetrics[15])) : 0}
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="bg-blue-50 dark:bg-blue-900/20 p-3 rounded-lg">
                            <p className="text-blue-700 dark:text-blue-300 text-sm">
                                <strong>Note:</strong> Users holding ≥{creationHolderThresholdBps || "0"}% of SAFU total supply can create tokens for free. Others pay {creationFeeETH || "0"} ETH.
                            </p>
                        </div>
                        <ActionButton
                            onClick={() =>
