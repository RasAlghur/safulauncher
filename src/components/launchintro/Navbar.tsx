...
const Navbar = () => {
  ...
  return (
    <header
      className={`py-3 px-6 md:px-[79px] ${
        navBg ? "bg-Dark-Purple" : "bg-[#ffffff0d] backdrop-blur-[40px] shadow"
    ...
    >
      <nav className="flex items-center justify-between">
        ...
        {/* Main Controls */}
        <div className="flex items-center w-full max-w-[700px] mx-6">
          {/* Dropdown Button */}
          <div className="relative z-50" ref={dropdownRef}>
            <button
              onClick={() => setShowMenu(!showMenu)}
              className="flex items-center dark:bg-[#0C8CE0]/43 bg-[#0C8CE0] text-white px-4 py-3 rounded-l-lg text-sm font-medium cursor-pointer"
            >
  ...
  dark:bg-[#02071E]/95 dark:backdrop-blur-none 
  border border-white/10 
  text-white shadow-2xl rounded-2xl z-50 space-y-1"
              >
        ...
        {/* Connect Wallet */}
        {/* <button className="bg-[#1A9AF7] hover:bg-Primary text-white font-semibold px-4 py-2 rounded-xl text-sm">
          Connect Wallet
        </button> */}
        <ConnectButton />
        <ThemeToggle />
