        ...
        >
          ...
          <div className="flex flex-col gap-[10px] mt-[34px]">
            ...
            <div className="grid grid-cols-[.2fr_.8fr] lg:flex items-center gap-2">
              <div
                className={`relative w-[54px] h-8 flex items-center  ${enableTax
                    ? "bg-Primary"
              ...
              >
                ...
                />
                <div
                  className={`w-6 h-6 bg-white rounded-full shadow-md transform duration-300 ease-in-out ${enableTax ? "translate-x-6" : "translate-x-0"
                    }`}
                />
              </div>
          ...
          <div className="flex flex-col gap-[10px] mt-[34px]">
            ...
            <div className="grid grid-cols-[.2fr_.8fr] lg:flex items-center gap-2">
              <div
                className={`relative w-[54px] h-8 flex items-center ${enableWhitelist
                    ? "bg-Primary"
                    : " dark:bg-[#d5f2f80a] bg-[#01061c0d]"
                  }  rounded-full p-1 cursor-pointer`}
              ...
              >
                ...
                />
                <div
                  className={`w-6 h-6 bg-white rounded-full shadow-md transform duration-300 ease-in-out ${enableWhitelist ? "translate-x-6" : "translate-x-0"
                    }`}
                />
              </div>
              <span className="dark:text-white text-black lg:text-lg">
          ...
          <div className="flex flex-col gap-[10px] mt-[34px]">
            ...
            <div className="grid grid-cols-[.2fr_.8fr] lg:flex items-center gap-2">
              <div
                className={`relative w-[54px] h-8 flex items-center ${startNow
                    ? "bg-Primary"
                    : " dark:bg-[#d5f2f80a] bg-[#01061c0d]"
                  } rounded-full p-1 cursor-pointer`}
              ...
              >
                ...
                />
                <div
                  className={`w-6 h-6 bg-white rounded-full shadow-md transform duration-300 ease-in-out ${startNow ? "translate-x-6" : "translate-x-0"
                    }`}
                />
              </div>
              <span className="dark:text-white text-black lg:text-lg">
          ...
          <div className="flex flex-col gap-[10px] mt-[34px]">
            ...
            <div className="grid grid-cols-[.2fr_.8fr] lg:flex items-center gap-2">
              <div
                className={`relative w-[54px] h-8 flex items-center ${enableBundle
                    ? "bg-Primary"
                    : " dark:bg-[#d5f2f80a] bg-[#01061c0d]"
                  } rounded-full p-1 cursor-pointer`}
              ...
              >
                ...
                />
                <div
                  className={`w-6 h-6 bg-white rounded-full shadow-md transform duration-300 ease-in-out ${enableBundle ? "translate-x-6" : "translate-x-0"
                    }`}
                />
              </div>
              <span className="dark:text-white text-black lg:text-lg">
          ...
          <div className="flex flex-col gap-[10px] mt-[34px]">
            ...
            <div className="grid grid-cols-[.2fr_.8fr] lg:flex items-center gap-2">
              <div
                className={`relative w-[54px] h-8 flex items-center ${enablePlatformFee
                    ? "bg-Primary"
                    : " dark:bg-[#d5f2f80a] bg-[#01061c0d]"
                  } rounded-full p-1 cursor-pointer`}
              ...
              >
                ...
                />
                <div
                  className={`w-6 h-6 bg-white rounded-full shadow-md transform duration-300 ease-in-out ${enablePlatformFee ? "translate-x-6" : "translate-x-0"
                    }`}
                />
              </div>
              <span className="dark:text-white text-black lg:text-lg">
